...
def kmeans(X, k, observer=None, threshold=1e-15, maxiter=300):
    N = len(X) #juzheng de lieshu 
    labels = zeros(N, dtype=int)
    centers = array(random.sample(X, k))#juzheng X zhao k lie random juzheng
    iter = 0
...
if __name__ == '__main__':
    ...
    def observer(iter, labels, centers):
        ...
        pyplot.savefig('/Users/ishida/Documents/workspace/thesis/src/cluster/iter_%02d.png' % iter, format='png')
